...
def index(request):
    ...
    context = {'todos' : get_showing_todos(request , todos),'all_count' : all_count,'completed_count' :
                completed_count ,'incomplete_count' : incomplete_count}
...
def create_todo(request):
    ...
    if request.method  == 'POST' :
        ...
        messages.add_message ( request,messages.SUCCESS , "Todo created successfuly" )
...
def todo_delete(request, id) : 
    ...
    if request.method == 'POST':
        ...
        messages.add_message ( request,messages.SUCCESS , "Todo deleted successfuly" )
