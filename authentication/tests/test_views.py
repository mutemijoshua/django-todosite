...
class Testviews(TestCase):
    ...
    def test_should_not_signup_user_with_taken_user_name(self):
        ...
        print(errors)
        '''
        self.assertIn("Username is taken, please choose another one", list(map(lambda x : x.message, storage)))
